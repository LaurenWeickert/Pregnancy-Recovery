      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="fixed top-0 left-0 right-0 bg-white z-30 shadow-sm py-2 px-2 sm:py-3 sm:px-4">
          ...
          <div className="container mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 relative">
            ...
            <button
              className="sm:hidden absolute left-2 top-1/2 transform -translate-y-1/2 p-2 rounded-md hover:bg-brand-gold/20 focus:outline-none z-40"
              ...
              <>
                ...
                <div className="fixed top-0 left-0 h-full w-4/5 max-w-xs bg-white shadow-lg z-50 transition-transform duration-300 ease-in-out transform translate-x-0">
                  <div className="flex flex-col h-full">
                    <div className="flex items-center justify-between px-4 py-4 border-b border-brand-gold/30">
                      <span className="font-semibold text-brand-green text-lg">Menu</span>
                      <button className="p-2 rounded-md hover:bg-brand-gold/20" onClick={() => setMobileMenuOpen(false)} aria-label="Close menu">
                          ...
                          <button
                            ...
                            className={`flex items-center px-4 py-3 rounded-lg text-base font-medium transition-colors w-full text-left mb-1 whitespace-nowrap ${
                              activeTab === tab.id
                                ...
                                : 'text-gray-700 hover:text-brand-green hover:bg-brand-gold/10'
                            }`}
                          >
            ...
            <a href="#" className="flex items-center gap-2 justify-center sm:justify-start min-w-0 mx-auto sm:mx-0">
              <span className="text-base sm:text-lg font-semibold text-brand-green whitespace-nowrap truncate max-w-[70vw] sm:max-w-xs">Postpartum Chat</span>
            </a>
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center px-4 py-2 rounded-full text-sm font-medium transition-colors whitespace-nowrap ${
                        activeTab === tab.id
                          ? 'bg-brand-gold/20 text-brand-green'
                          : 'text-gray-600 hover:text-brand-green hover:bg-brand-gold/10'
                      }`}
                    >
